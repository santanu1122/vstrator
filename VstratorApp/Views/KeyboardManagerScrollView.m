...
#import "KeyboardManagerScrollView.h"

#define _UIKeyboardFrameEndUserInfoKey (&UIKeyboardFrameEndUserInfoKey != NULL ? UIKeyboardFrameEndUserInfoKey : @"UIKeyboardBoundsUserInfoKey")

@interface KeyboardManagerScrollView ()
...
@implementation KeyboardManagerScrollView
...
- (void)keyboardWillHide:(NSNotification*)notification {
    ...
    [UIView setAnimationCurve:[[[notification userInfo] objectForKey:UIKeyboardAnimationCurveUserInfoKey] intValue]];
    [UIView setAnimationDuration:[[[notification userInfo] objectForKey:UIKeyboardAnimationDurationUserInfoKey] floatValue]];
    self.contentInset = UIEdgeInsetsMake(_priorInset.top, _priorInset.left, _priorInset.bottom - [self keyboardRect].size.height, _priorInset.right);
    [self setScrollIndicatorInsets:self.contentInset];
    _priorInsetSaved = NO;
